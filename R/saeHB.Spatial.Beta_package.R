...
#' The package supports both non-spatial models and spatial models based on the Simultaneous Autoregressive (SAR) and Leroux Conditional Autoregressive (CAR) structures for area-level random effects, with optional survey design effect (DEFF) adjustments for sampling variances.
...
#' The \code{runjags} package is used to obtain posterior estimates via Markov Chain Monte Carlo (MCMC) with parallel computing capabilities.
#'
#' @section Author(s):
...
#' @section Reference:
#' \itemize{
#'   \item{Rao, J. N. K., & Molina, I. (2015). Small Area Estimation (2nd ed.). New Jersey: John Wiley & Sons, Inc. <doi:10.1002/9781118735855>.}
...
#'   \item{Kubacki, J., & Jedrzejczak, A. (2016). Small Area Estimation of Income Under Spatial SAR Model. Statistics in Transition New Series, 17(3), 365--390. <doi:10.59170/stattrans-2016-022>.}
...
#'   \item{Figueroa-Zúñiga, J. I., Arellano-Valle, R. B., & Ferrari, S. L. P. (2013). Mixed beta regression: A Bayesian perspective. Computational Statistics & Data Analysis, 61, 137-147. <doi:10.1016/j.csda.2012.12.002>.}
#'   \item{Denwood, M. J. (2016). runjags: An R Package Providing Interface Utilities, Model Templates, Parallel Computing Methods and Additional Distributions for MCMC Models in JAGS. Journal of Statistical Software, 71(9), 1-25. <doi:10.18637/jss.v071.i09>.}
