...
#'   \item {This function gives estimation of small area means under Spatial Leroux Conditional Autoregressive (CAR) Model using Hierarchical Bayesian Method with Design Effect (DEFF) adjustment.}
#' }
#'
...
#' @import graphics
#'
#' @export betaDeffLerouxCAR
betaDeffLerouxCAR <- function(formula, DEFF, n_i, proxmat, data,
  ...
  params <- c("mu", "a.var", "beta", "rho", "tau_v", "sigma2_v", "v")
