...
#'   \item {This function gives estimation of small area means under Spatial Simultaneous Autoregressive (SAR) Model using Hierarchical Bayesian Method.}
...
#'
#' @export betaSAR
betaSAR <- function(formula, proxmat, data,
